function Controller() {
    ...
    var openScanner = function() {
        ...
        picker.setSuccessCallback(function(e) {
            ...
            alert("Ti.Filesystem.tempDirectory, " + Ti.Filesystem.tempDirectory + " Ti.Filesystem.externalStorageDirectory, " + Ti.Filesystem.externalStorageDirectory);
            if (false === Ti.Filesystem.isExternalStoragePresent()) var f = Ti.Filesystem.getFile(Ti.Filesystem.tempDirectory, "barcode.txt");
            var f = Ti.Filesystem.getFile(Ti.Filesystem.externalStorageDirectory, "barcode.txt");
            f.write("barcode is : " + e.barcode);
        });
